...
Ported from upstream Dograh PR #388: the public signaling WebSocket
...
async def test_public_signaling_rejects_disallowed_origin():
    ...
    # A valid session token presented from an origin outside the embed allowlist
    # must be rejected before the signaling handoff.
